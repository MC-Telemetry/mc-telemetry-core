package de.mctelemetry.core.geo.renderer.items.submodelitems
...
import de.mctelemetry.core.geo.renderer.items.submodelitems.layers.SubModelItemStatusRenderLayer
...
object SubModelItemRendererFactory {
    // createGeoRenderer in GeoItem explicitly requires anonymous classes for some reason
    fun createGeoRenderer(includeStatusLayer: Boolean, model: GeoModel<GeoSubModelItem>, consumer: Consumer<GeoRenderProvider>) {
        consumer.accept(object : GeoRenderProvider {
            private val renderer: GeoItemRenderer<GeoSubModelItem> by lazy {
                (object : GeoItemRenderer<GeoSubModelItem>(model) {
                    ...
                    if(includeStatusLayer) {
                        addRenderLayer(SubModelItemStatusRenderLayer(this@apply))
                    }
                }
            }
