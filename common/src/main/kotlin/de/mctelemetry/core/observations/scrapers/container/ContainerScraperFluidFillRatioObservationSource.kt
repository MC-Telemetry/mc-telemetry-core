...
object ContainerScraperFluidFillRatioObservationSource :
    PositionObservationSourceBase.PositionSingletonBase.Simple<ContainerScraperFluidFillRatioObservationSource>() {

    override val id: ResourceKey<IObservationSource<*, *>> = ResourceKey.create(
        OTelCoreModAPI.ObservationSources,
        ResourceLocation.fromNamespaceAndPath(OTelCoreModAPI.MOD_ID, "container_scraper.fluid.fill_ratio")
    )
